            ...
            var diaporama = {
                ...
                _animateThumbs: function(pos) {
                    ...
                    if (($(document).width() / 2) < pos.pageX) {
                        $(me._opt.thumbsContainer).animate({ scrollLeft: Math.max(0, $(me._opt.thumbsContainer).scrollLeft() + me._thumbSize) },
                            800
                        );
                    } else {
                        $(me._opt.thumbsContainer).animate({ scrollLeft: Math.max(0, $(me._opt.thumbsContainer).scrollLeft() - me._thumbSize) },
                ...
                _showPicture: function(thumb) {
                    ...
                    $(this._opt.jObject).find("img").fadeOut('slow', function() {
                        ...
                        $(me._opt.jObject).animate({ height: (_img.height / me._opt.zoomLevel) + 'px' },
                            500,
                            function() {
